...
const components = [
	{
		js: () => Promise.all([import('./index.4b807b5c.js'), __inject_styles(["index-32ca9f0c.css"])]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./register.90b30a14.js'), ]).then(function(x) { return x[0]; })
	},
	{
		js: () => Promise.all([import('./login.27fce105.js'), ]).then(function(x) { return x[0]; })
	}
];
